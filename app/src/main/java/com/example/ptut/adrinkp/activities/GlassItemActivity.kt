...
import com.example.ptut.adrinkp.adapters.GlassItemsAdapter
...
class GlassItemActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener, CategoryView {
    ...
    override fun launchFilter(itemName: String) {
        startActivity(CategoryFilterActivity.newIntent(applicationContext, itemName, AppConstant.GLASS_NAME))
    }
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar_title.text = AppConstant.GLASS_NAME
